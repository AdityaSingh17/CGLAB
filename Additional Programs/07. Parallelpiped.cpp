/* Draw a cylinder and parallelpiped by extruding circle and quadilateral. */
#include<GL/glut.h>
#include<math.h>
#include<stdio.h>
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("Cylinder and parallelopipoed Display by Extruding circle and quadrilateral");
	init();
